...
export default function RoiChart({
  ...
  return (
    <div className="mb-10 w-full overflow-x-auto min-w-[300px]">
      ...
      {!isPro && (
        <div className="absolute inset-0 bg-white bg-opacity-80 backdrop-blur-sm flex items-center justify-center z-10 rounded">
          <div className="text-center">
            <p className="text-gray-800 font-medium mb-2">Upgrade to see ROI trends over time</p>
